...
<div class="mt-6 flex flex-col justify-center gap-3 sm:my-12 sm:flex-row sm:gap-6">
	<Button class="text-md flex items-center justify-center gap-1 rounded-full xl:text-xl" href="/fix"
		>{m.fixButton()}</Button
	>
	<Button
