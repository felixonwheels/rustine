...
export interface paths {
  ...
  "/items/about_translations": {
    /**
     * List Items
     * @description List the about_translations items.
     */
    get: operations["readItemsAboutTranslations"];
    /**
     * Create an Item
     * @description Create a new about_translations item.
     */
    post: operations["createItemsAboutTranslations"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing about_translations items.
     */
    delete: operations["deleteItemsAboutTranslations"];
    /**
     * Update Multiple Items
     * @description Update multiple about_translations items at the same time.
     */
    patch: operations["updateItemsAboutTranslations"];
  };
  "/items/about_translations/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single about_translations item by unique identifier.
     */
    get: operations["readSingleItemsAboutTranslations"];
    /**
     * Delete an Item
     * @description Delete an existing about_translations item.
     */
    delete: operations["deleteSingleItemsAboutTranslations"];
    /**
     * Update an Item
...
export interface components {
  schemas: {
    ...
    ItemsAbout: {
      ...
      /** Format: timestamp */
      date_updated?: string | null;
      translations?: ((number | components["schemas"]["ItemsAboutTranslations"])[]) | null;
    };
    ItemsAboutTranslations: {
      id?: number;
...
export interface operations {
  ...
  createItemsTools: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsTools"][] | components["schemas"]["ItemsTools"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  readItemsAboutTranslations: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsAboutTranslations"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsAboutTranslations: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsAboutTranslations"][] | components["schemas"]["ItemsAboutTranslations"];
      };
    };
    responses: {
      /** @description Successful request */
   ...
   * @description Retrieve a single about_translations item by unique identifier.
   */
  readSingleItemsAboutTranslations: {
    parameters: {
      query?: {
        fields?: components["parameters"]["Fields"];
        meta?: components["parameters"]["Meta"];
   ...
   * @description Delete an existing about_translations item.
   */
  deleteSingleItemsAboutTranslations: {
    parameters: {
      path: {
        /** @description Index of the item. */
        id: number | string;
   ...
   * @description Update an existing about_translations item.
   */
  updateSingleItemsAboutTranslations: {
    parameters: {
      query?: {
        fields?: components["parameters"]["Fields"];
        meta?: components["parameters"]["Meta"];
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsAboutTranslations"];
      };
    };
    responses: {
      /** @description Successful request */
